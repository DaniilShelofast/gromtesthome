...
public class Demo {
    public static void main(String[] args) {
        File file1 = new File("test", "C:/user/home", "jpg", 11);
        File file2 = new File("test", "C:/user/home", "jpg", 11);
        File file3 = new File("video", "C:/user/home", "jpg", 11);
        File file4 = new File("test", "C:/user/home", "jpg", 11);
